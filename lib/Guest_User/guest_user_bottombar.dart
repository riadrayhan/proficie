...
import 'guest_user_homescreen.dart';

class GuestUser_BottomBar extends StatefulWidget {
  const GuestUser_BottomBar({super.key});

  @override
  State<GuestUser_BottomBar> createState() => _GuestUser_BottomBarState();
}

class _GuestUser_BottomBarState extends State<GuestUser_BottomBar> {
  int currentIndex = 0;
  ColorNotifire notifier = ColorNotifire();
  List<Widget> myChildren = [
    const GuestUser_HomeScreen(),
    const Bookmark(),
